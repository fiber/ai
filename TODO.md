...
- [ ] T-056 — Benchmark EmbeddingGemma against llama.cpp at matched precision (spec/T-056-benchmark-embeddinggemma-against-llama-cpp-at-ma.md)
- [ ] T-061 — Benchmark sections must not inherit the allocator state of the section before them (spec/T-061-benchmark-sections-must-not-inherit-the-allocato.md)
