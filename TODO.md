...
- [ ] T-044 — Result recycling without Release: cheaper forced collections and released exp/tanh rows for the kernel comparison (spec/T-044-result-recycling-without-release-cheaper-forced.md)
