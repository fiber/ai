...
- [ ] T-025 — Fused attention: scores per row block with the softmax in registers, no materialised [T×S] matrix; PyTorch baseline for [8×8×512×64] in the Python bench
