...
- [ ] T-046 — Attention v2: online softmax over key blocks and a micro-kernel that reads its left operand row-major, so nothing is packed per row group (spec/T-046-attention-v2-online-softmax-over-key-blocks-and.md)
